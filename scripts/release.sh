...
echo "Releasing ligo-cache: $LATEST → $VERSION"
...
gh release create "$VERSION" --repo linkeunid/ligo-cache --title "$VERSION" --notes "" --latest

echo "Released ligo-cache $VERSION"
